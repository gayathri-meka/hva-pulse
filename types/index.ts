...
export type RoleWithCounts = Role & { applicant_count: number; hired_count: number; not_interested_count: number; ongoing_count: number }
...
export type Application = {
  ...
  status: 'applied' | 'shortlisted' | 'interviews_ongoing' | 'on_hold' | 'not_shortlisted' | 'rejected' | 'hired' | 'placed_elsewhere'
