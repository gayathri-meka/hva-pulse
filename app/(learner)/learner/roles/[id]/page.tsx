    ...
    <div className="mx-auto max-w-2xl px-4 py-6 @lg:max-w-6xl">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-3 flex flex-wrap gap-4">
          ...
          {(role as unknown as { created_at: string | null }).created_at && (
            <span className="flex items-center gap-1.5 text-base font-medium text-zinc-600">
              ...
              Posted {new Date((role as unknown as { created_at: string }).created_at).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}
            </span>
          )}
        </div>
