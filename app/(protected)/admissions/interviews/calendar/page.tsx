...
export default async function CalendarPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-zinc-500">Drag to mark when you&apos;re free. Each 30-minute slot becomes bookable by candidates. Booked interviews show in blue.</p>
